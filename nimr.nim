...
## Removes the nimr metadata cache directory (entire ``$HOME/.cache/nimr`` tree).
  ...
  cliRun(
    CliSchema(
      commands: @[
        cliLeaf(
          "cache-clear",
          "Remove the nimr metadata cache directory.",
      ...
      description: "Single-file Nim runner (POSIX): metadata-keyed run cache, optional temp module when the path is not a valid Nim module filename, then nim c and execv.",
